...
public class DummyStepDialog extends BaseStepDialog implements StepDialogInterface {
    private DummyStepMeta input;
    ...
    public DummyStepDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        input = (DummyStepMeta) in;
    ...
    public String open() {
        ...
        shell.setText( BaseMessages.getString( "DummyPluginDialog.Shell.Title" ) ); //$NON-NLS-1$
        ...
        wlStepname.setText( BaseMessages.getString( "DummyPluginDialog.StepName.Label" ) ); //$NON-NLS-1$
        ...
        wlValName.setText( BaseMessages.getString( "DummyPluginDialog.ValueName.Label" ) ); //$NON-NLS-1$
        ...
        wlValue.setText( BaseMessages.getString( "DummyPluginDialog.ValueToAdd.Label" ) ); //$NON-NLS-1$
